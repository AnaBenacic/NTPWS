...
if (!isset($_GET['action']) || $_GET['action'] == 1) { 
	print'
		<h1>News</h1>
		<div class="news">
			<a href="index.php?menu=2&action=2"><img src="news/news-3-1.jpg" alt="Guardians of the Galaxy OST 3" title="Guardians of the Galaxy OST 3"></a>
			<h2><a href="index.php?menu=2&action=2">Guardians of the Galaxy OST vol. 3 is here!</a></h2>
			<p>Guardians of the Galaxy Vol. 3: Awesome Mix Vol. 3 is the soundtrack album for the Marvel Studios film Guardians of the Galaxy Vol. 3. <a href="index.php?menu=2&action=2">More ...</a></p>
			<p><time datetime="2024-10-13">13 October 2024</time></p>
			<hr>
			<a href="index.php?menu=2&action=3"><img src="news/news-2-1.jpg" alt="Uzumaki by Junji Ito" title="Uzumaki by Junji Ito"></a>
			<h2><a href="index.php?menu=2&action=3">Read recommendation: Uzumaki by Junji Ito</a></h2>
			<p>Uzumaki is a Japanese horror manga series written and illustrated by Junji Ito. <a href="index.php?menu=2&action=3">More ...</a></p>
			<p><time datetime="2024-10-13">13 October 2024</time></p>
			<hr>
			<a href="index.php?menu=2&action=4"><img src="news/news-1-1.jpg" alt="Cross Stitching" title="Cross Stitching"></a>
			<h2><a href="index.php?menu=2&action=4">Introduction to cross stitching</a></h2>
			<p>Cross stitching is a form of sewing and a popular form of counted-thread embroidery in which X-shaped stitches in a tiled, raster-like pattern are used to form a picture. <a href="index.php?menu=2&action=4">More ...</a></p>
			<p><time datetime="2024-10-13">13 October 2024</time></p>
			<hr>
		</div>';
}
...
# News3
	...
	setcookie('news_title_3', 'Guardians of the Galaxy OST vol. 3 is here!', time() + 300, '/'); // expires in 5 minutes
    setcookie('news_url_3', 'index.php?menu=2&action=2', time() + 300, '/'); // expires in 5 minutes
	print'
		<h1>News</h1>
		<div id="news_gallery">
			<figure id="1">
...
# News2
	...
	setcookie('news_title_2', 'Read recommendation: Uzumaki by Junji Ito', time() + 300, '/'); // expires in 5 minutes
    setcookie('news_url_2', 'index.php?menu=2&action=3', time() + 300, '/'); // expires in 5 minutes
	print'
		<h1>News</h1>
		<div id="news_gallery">
			<figure id="4">
...
# News1
	...
	setcookie('news_title_1', 'Introduction to cross stitching', time() + 300, '/'); // expires in 5 minutes
    setcookie('news_url_1', 'index.php?menu=2&action=4', time() + 300, '/'); // expires in 5 minutes
	print'
		<h1>News</h1>
		<div id="news_gallery">
			<figure id="8">
